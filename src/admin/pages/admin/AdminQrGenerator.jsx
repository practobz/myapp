          ...
          <div className="mb-8">
            <div className="flex items-center gap-3 mb-2">
              ...
              <div>
                ...
                <p className="text-slate-600 mt-1">Generate social media QR codes for your assigned customers</p>
              </div>
            </div>
          </div>
            ...
            <div className="lg:col-span-2">
              <div className="bg-white rounded-xl shadow-sm border border-slate-200">
                <div className="px-6 py-4 border-b border-slate-200">
                  <h2 className="text-lg font-semibold text-slate-900">Your Assigned Customers</h2>
                  <p className="text-sm text-slate-600 mt-1">Select a platform to generate QR code for your customers</p>
                </div>
                ...
                <div className="divide-y divide-slate-200">
                  {fetchingCustomers ? (
                    <div className="px-6 py-12 text-center">
                      ...
                      <p className="text-slate-600">Loading your assigned customers...</p>
                    </div>
                  ) : customers.length === 0 ? (
                    <div className="px-6 py-12 text-center">
                      <User className="w-12 h-12 text-slate-300 mx-auto mb-3" />
                      <h3 className="text-lg font-medium text-slate-900 mb-2">No customers assigned</h3>
                      <p className="text-slate-600">You don't have any customers assigned to you yet.</p>
                      <p className="text-sm text-slate-500 mt-2">Contact your Super Admin to get customers assigned.</p>
                    </div>
                  ) : (
                      ...
                      >
                        <div className="flex items-start justify-between gap-4">
                          <div className="flex-1 min-w-0">
                            ...
                            <span className="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium bg-green-100 text-green-800 border border-green-200 mt-2">
                              ASSIGNED TO YOU
                            </span>
                          </div>

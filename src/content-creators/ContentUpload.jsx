...
for (const fileObj of uploadedFiles) {
 ...
 const res = await fetch(
  `http://localhost:3001/api/gcs/generate-upload-url?filename=${encodeURIComponent(safeFileName)}&contentType=${encodeURIComponent(fileObj.file.type)}`
);
  ...
  uploadedImageUrls.push(publicUrl);
    ...
    const response = await fetch('http://localhost:3001/api/content-submissions', {
      method: 'POST',
      headers: {

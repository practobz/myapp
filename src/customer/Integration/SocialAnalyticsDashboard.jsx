...
function SocialAnalyticsDashboard() {
  ...
  return (
    <ErrorBoundary>
      <div className="w-full min-h-screen bg-[#e6f2fb] px-2 sm:px-4 lg:px-8 py-4">
        {/* Enhanced Header */}
        <div className="text-center bg-gradient-to-br from-[#0a2342] via-[#38bdf8] to-[#bae6fd] rounded-3xl p-4 sm:p-8 border border-[#bae6fd] max-w-5xl mx-auto">
          <div className="flex items-center justify-center space-x-3 mb-6">
            <div className="bg-gradient-to-br from-[#0a2342] to-[#38bdf8] p-4 rounded-2xl shadow-lg">
              <Award className="h-10 w-10 text-white" />
            </div>
            <div>
              <h1 className="text-4xl font-bold bg-gradient-to-r from-[#0a2342] to-[#38bdf8] bg-clip-text text-transparent">
                Social ROI & Analytics Dashboard
              </h1>
              <p className="text-[#0a2342] text-lg font-medium">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
            <div className="bg-white bg-opacity-60 rounded-xl p-4 backdrop-blur-sm">
              ...
              <div className="text-2xl font-bold text-[#0a2342]">{metrics.totalFollowers.toLocaleString()}</div>
              <div className="text-sm text-[#0a2342]/70">Total Audience Reach</div>
            </div>
            <div className="bg-white bg-opacity-60 rounded-xl p-4 backdrop-blur-sm">
              <div className="flex items-center justify-center mb-2">
                <Activity className="h-5 w-5 text-green-600" />
              </div>
              <div className="text-2xl font-bold text-[#0a2342]">{metrics.totalEngagement.toLocaleString()}</div>
              <div className="text-sm text-[#0a2342]/70">Total Engagements</div>
            </div>
            <div className="bg-white bg-opacity-60 rounded-xl p-4 backdrop-blur-sm">
              <div className="flex items-center justify-center mb-2">
                <FileText className="h-5 w-5 text-purple-600" />
              </div>
              <div className="text-2xl font-bold text-[#0a2342]">{metrics.totalContent}</div>
              <div className="text-sm text-[#0a2342]/70">Content Pieces</div>
            </div>
          </div>
          
          <div className="flex items-center justify-between">
            <div className="text-[#0a2342] text-sm">
              Report Period: Last 30 days | Generated {lastUpdated.toLocaleDateString()} at {lastUpdated.toLocaleTimeString()}
            </div>
            <button
              onClick={refreshAllData}
              disabled={refreshing}
              className="flex items-center space-x-2 bg-white bg-opacity-70 text-[#0a2342] px-4 py-2 rounded-lg hover:bg-[#bae6fd] transition-all disabled:opacity-50"
            >
        ...
        <div className="bg-gradient-to-br from-green-50 to-emerald-50 border border-green-200 rounded-3xl p-4 sm:p-8 shadow-sm max-w-5xl mx-auto mt-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4 sm:gap-6 mb-8">
            <div className="bg-white bg-opacity-80 rounded-xl p-4 sm:p-6 shadow-sm">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 max-w-5xl mx-auto mt-6">
          <MetricCard
        ...
        <div className="max-w-5xl mx-auto mt-6">
          ...
          >
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              {/* Wrap charts in overflow-x-auto for mobile */}
            ...
            <div className="mt-8 bg-gradient-to-r from-gray-50 to-blue-50 rounded-2xl p-4 sm:p-6">
          ...
          >
            <div className="space-y-6">
              ...
              {getInstagramInsights() && (
                <div className="bg-pink-50 rounded-2xl p-4 sm:p-6">
        ...
        <div className="bg-gradient-to-br from-gray-50 to-slate-50 border border-gray-200 rounded-3xl p-4 sm:p-8 shadow-sm max-w-5xl mx-auto mt-6">
          <div className="flex flex-col md:flex-row items-center justify-between mb-8 gap-4">
            <div className="flex items-center space-x-4">
        ...
        <div className="bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50 border border-indigo-200 rounded-3xl p-4 sm:p-8 shadow-lg max-w-5xl mx-auto mt-6">
          ...
          <div className="mt-12 pt-8 border-t border-indigo-200">
            <div className="bg-gradient-to-r from-white to-blue-50 rounded-2xl p-4 sm:p-8 shadow-lg border border-white">
              <div className="text-center">
        ...
        <div className="bg-white border border-gray-200 rounded-2xl p-4 sm:p-6 shadow-sm max-w-5xl mx-auto mt-6">
